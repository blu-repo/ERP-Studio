...
<body>
  ...
  <br><br><br><br><br>
    <h2 class="h3_home wow fadeIn" data-wow-delay="0.6s">El modulo Contador se encuentra en desarrollo</h2>
    <a class="wow fadeIn" data-wow-delay="0.9s" href="../index.php">Regresa mas tarde</a>
  </div>
